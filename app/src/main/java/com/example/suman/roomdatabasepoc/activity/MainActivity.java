...
//import com.example.suman.roomdatabasepoc.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnClick.setOnClickListener(view ->
                DatabaseInitializer.populateAsync(AppDatabase.getInstance(getApplicationContext(), new AppExecutors())));
